...
public class FEntwumSNetlistReaderFrontendModule : OneWareModuleBase
{
			...
			new PackageVersion()
			{
				...
				[
					new PackageTarget()
					{
						Target = "all",
						Url =
							"https://github.com/FEntwumS/NetlistReaderBackend/releases/download/v0.11.8/fentwums-netlist-reader-server-v0.11.8.tar.gz",
						AutoSetting =
						[
							new PackageAutoSetting()
							{
			...
			new PackageVersion()
			{
				...
				[
					new PackageTarget()
					{
						Target = "all",
						Url =
							"https://github.com/FEntwumS/NetlistReaderBackend/releases/download/v0.11.9/fentwums-netlist-reader-server-v0.11.9.tar.gz",
						AutoSetting =
						[
							new PackageAutoSetting()
							{
			...
			new PackageVersion()
			{
				...
				[
					new PackageTarget()
					{
						Target = "all",
						Url =
							"https://github.com/FEntwumS/NetlistReaderBackend/releases/download/v0.11.10/fentwums-netlist-reader-server-v0.11.10.tar.gz",
						AutoSetting =
						[
							new PackageAutoSetting()
							{
			...
			new PackageVersion()
			{
				...
				[
					new PackageTarget()
					{
						Target = "all",
						Url =
							"https://github.com/FEntwumS/NetlistReaderBackend/releases/download/v0.12.0/fentwums-netlist-reader-server-v0.12.0.tar.gz",
						AutoSetting =
						[
							new PackageAutoSetting()
							{
			...
			new PackageVersion()
			{
				...
				[
					new PackageTarget()
					{
						Target = "all",
						Url =
							"https://github.com/FEntwumS/NetlistReaderBackend/releases/download/v0.12.1/fentwums-netlist-reader-server-v0.12.1.tar.gz",
						AutoSetting =
						[
							new PackageAutoSetting()
							{
			...
			new PackageVersion()
			{
				...
				[
					new PackageTarget()
					{
						Target = "all",
						Url =
							"https://github.com/FEntwumS/NetlistReaderBackend/releases/download/v0.12.2/fentwums-netlist-reader-server-v0.12.2.tar.gz",
						AutoSetting =
						[
							new PackageAutoSetting()
							{
			...
			new PackageVersion()
			{
				...
				[
					new PackageTarget()
					{
						Target = "all",
						Url =
							"https://github.com/FEntwumS/NetlistReaderBackend/releases/download/v0.12.3/fentwums-netlist-reader-server-v0.12.3.tar.gz",
						AutoSetting =
						[
							new PackageAutoSetting()
							{
			...
			new PackageVersion()
			{
				...
				[
					new PackageTarget()
					{
						Target = "all",
						Url =
							"https://github.com/FEntwumS/NetlistReaderBackend/releases/download/v0.12.4/fentwums-netlist-reader-server-v0.12.4.tar.gz",
						AutoSetting =
						[
							new PackageAutoSetting()
							{
			...
			new PackageVersion()
			{
				...
				[
					new PackageTarget()
					{
						Target = "all",
						Url =
							"https://github.com/FEntwumS/NetlistReaderBackend/releases/download/v0.12.5/fentwums-netlist-reader-server-v0.12.5.tar.gz",
						AutoSetting =
						[
							new PackageAutoSetting()
							{
	...
	private void RegisterSettings()
	{
		...
		ServiceManager.GetService<ISettingsService>().RegisterSetting("Netlist Viewer", "Experimental",
			FentwumSNetlistViewerSettingsHelper.JunctionShapeKey, new ComboBoxSetting("Junction Shape", "Line",
